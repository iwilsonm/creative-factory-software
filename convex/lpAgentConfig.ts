...
export const upsertConfig = mutation({
  args: {
    ...
    chief_checkpoint_enabled: v.optional(v.boolean()),
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      const replacement: Record<string, any> = {
        ...
        chief_checkpoint_enabled: existing.chief_checkpoint_enabled,
      ...
      await ctx.db.insert("lp_agent_config", {
        ...
        default_narrative_frames: args.default_narrative_frames ?? JSON.stringify(["listicle"]),
        template_selection_mode: args.template_selection_mode ?? "random",
        chief_checkpoint_enabled: args.chief_checkpoint_enabled ?? true,
