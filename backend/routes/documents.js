    ...
    if (allDocsExist) {
      ...
      if (!existingBof) {
        await createConductorAngle({
          ...
          description: 'Core Buyer: Warm prospects who already know about the product.\nSymptom Pattern: Hesitation at the point of purchase.\nObjection: Price concerns, skepticism about results.\nScene: Shopping online, almost clicking buy but closing the tab.\nDesired Belief Shift: This is the right choice, now is the right time.',
