  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto fade-in">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">New Project</h1>
          <p className="text-[13px] text-gray-500 mt-0.5">Set up a new ad creative project</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-[13px] font-medium text-gray-600">Sales Page Content</label>
                ...
                {form.sales_page_content && uploadedFile && (
                  <div className="mt-3">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[12px] text-gray-400">Extracted content preview</span>
                      <button
                        type="button"
                        onClick={() => setSalesInputMode('paste')}
                        className="text-[12px] text-blue-500 hover:text-blue-600 transition-colors"
                      >
                        Edit text
                      </button>
                    </div>
                    <div className="bg-gray-50/50 border border-gray-200/60 rounded-xl p-3 max-h-32 overflow-y-auto text-[12px] text-gray-500 whitespace-pre-wrap scrollbar-thin">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-[13px] font-medium text-gray-600">Product Description</label>
              {describing && (
                <span className="text-[12px] text-blue-500 animate-pulse">Generating from sales page...</span>
              )}
            ...
            <textarea
              ...
              rows={3}
              className={`input-apple resize-none ${
                descAutoGenerated ? 'border-green-300/60 bg-green-50/30' : ''
              }`}
            ...
            {!form.product_description && form.sales_page_content && !describing && (
              <button
                ...
                className="text-[12px] text-blue-500 hover:text-blue-600 mt-1.5 transition-colors"
              >
