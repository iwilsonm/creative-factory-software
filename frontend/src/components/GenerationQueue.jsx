              ...
              return (
                <div key={gen.id} className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-50/80">
                  {gen.error ? (
                    ...
                    <div className="w-3.5 h-3.5 rounded-full border-2 border-gray-300 border-t-teal animate-spin flex-shrink-0" />
                  )}
                  ...
                  {!gen.error && gen.status !== 'completed' && gen.startTime && (
                    <span className="hidden sm:inline text-[10px] text-textlight whitespace-nowrap flex-shrink-0">
